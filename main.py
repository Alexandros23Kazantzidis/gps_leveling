...
class MainGui(object):
	...
	def __init__(self):
		...
		calculate.grid(row=4, column=2, ipadx=30, pady=10)
		...
		#
		#
		# # Tab 3 Variance Component Estimation
		#
		# # Button for importing the data
		# import_data = Button(input_frame_3, text="Import H", command=self.import_H)
		# import_data.grid(row=1, column=1, ipadx=30, pady=10)
		#
		# info_label_H = Label(input_frame_3, text="Format = H, σ")
		# info_label_H.grid(row=2, column=1)
		#
		# self.list_H_3 = Text(input_frame_3, height=10, width=30)
		# self.list_H_3.grid(row=3, column=1, pady=10)
		#
		# # Button for importing the data
		# import_data = Button(input_frame_3, text="Import h", command=self.import_h)
		# import_data.grid(row=1, column=2, ipadx=30, pady=10)
		...
		# info_label_h.grid(row=2, column=2)
		#
		# self.list_h = Text(input_frame_3, height=10, width=30)
		# self.list_h.grid(row=3, column=2, pady=10)
		#
		# # Button for importing the data
		# import_data = Button(input_frame_3, text="Import N", command=self.import_N)
		# import_data.grid(row=1, column=3, ipadx=30, pady=10)
		#
		# info_label_N = Label(input_frame_3, text="Format = N, σ")
		# info_label_N.grid(row=2, column=3)
		#
		# self.list_N = Text(input_frame_3, height=10, width=20)
		# self.list_N.grid(row=3, column=3, pady=10)
		#
		# info_label_cut_off = Label(input_frame_3, text="Input the cutoff error of the model")
		# info_label_cut_off.grid(row=4, column=3)
		#
		# self.cut_off = Text(input_frame_3, height=1, width=10)
		# self.cut_off.grid(row=5, column=3, padx=10)
		#
		# # Radio Button to choose the method - model of corrections
		# self.v = IntVar()
		# choose_method = Radiobutton(results_frame_3, text='Model with m, σΔH and σΔΝ', variable=self.v, value=1)
		# choose_method.grid(row=1, column=0)
		# choose_method = Radiobutton(results_frame_3, text='Model with m and σΔN ', variable=self.v, value=2)
		# choose_method.grid(row=2, column=0)
		# choose_method = Radiobutton(results_frame_3, text='Model with m and σΔH', variable=self.v, value=3)
		# choose_method.grid(row=3, column=0)
		#
		# # Button to run the calculation - estimation.py
		# calculate = Button(results_frame_3, text="Calculate Variance Components", command=self.calculate_components)
		# calculate.grid(row=4, column=0, ipadx=30, pady=10)
		#
		# # The results Text Field area that will shows us the computed values
		# self.display = Text(results_frame_3, height=10, width=25)
		# self.display.grid(row=5, column=0)
		#
		#
